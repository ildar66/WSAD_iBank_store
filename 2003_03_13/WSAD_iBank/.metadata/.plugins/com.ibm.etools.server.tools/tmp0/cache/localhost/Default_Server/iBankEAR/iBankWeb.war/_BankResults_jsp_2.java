...
public class _BankResults_jsp_2 extends HttpJspBase {
    ...
    public final void _jspx_init() throws JasperException {
        ...
        int numStrings = 0;
        try {
            InputStream fin = this.getClass().getClassLoader().getResourceAsStream("_BankResults_jsp_2.dat");
