...
public class _DOCUMENTS_jsp_36 extends HttpJspBase {
    ...
    public final void _jspx_init() throws JasperException {
        ...
        int numStrings = 0;
        try {
            InputStream fin = this.getClass().getClassLoader().getResourceAsStream("ibankjsp/_DOCUMENTS_jsp_36.dat");
