...
public class _CLIENT_0005fINFO_jsp_8 extends HttpJspBase {
    ...
    public _CLIENT_0005fINFO_jsp_8( ) {
    }
    ...
    public final void _jspx_init() throws JasperException {
        ...
        int numStrings = 0;
        try {
            InputStream fin = this.getClass().getClassLoader().getResourceAsStream("ibankjsp/_CLIENT_0005fINFO_jsp_8.dat");
